...
/obj/item/device/assembly_holder/HasProximity(var/atom/movable/AM as mob|obj)
	if(a_left)
...
/obj/item/device/assembly_holder/Crossed(var/atom/movable/AM as mob|obj)
	if(a_left)
		a_left.Crossed(AM)
	if(a_right)
		a_right.Crossed(AM)
...
/obj/item/device/assembly_holder/on_found(var/mob/finder as mob)
	if(a_left)
